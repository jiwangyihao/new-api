...
var (
	...
	ErrCreditValuationMigrationSuspended        = errors.New("credit_valuation_migration_suspended")
	ErrCreditValuationMigrationVersionRequired  = errors.New("credit_valuation_migration_version_required")
	ErrCreditValuationMigrationBatchInvalid     = errors.New("credit_valuation_migration_batch_invalid")
	ErrCreditValuationMigrationModeInvalid      = errors.New("credit_valuation_migration_mode_invalid")
	ErrCreditValuationMigrationReasonInvalid    = errors.New("credit_valuation_migration_reason_invalid")
	ErrCreditValuationMigrationConflict         = errors.New("credit_valuation_migration_conflict")
	ErrCreditValuationMigrationCASConflict      = errors.New("credit_valuation_migration_cas_conflict")
	ErrCreditValuationMigrationBlocked          = errors.New("credit_valuation_migration_blocked")
	ErrCreditValuationMigrationVerifyFailed     = errors.New("credit_valuation_migration_verify_failed")
	ErrCreditValuationMigrationChecksumMismatch = errors.New("credit_valuation_migration_checksum_mismatch")
	ErrCreditValuationMigrationFXUnavailable    = errors.New("credit_valuation_migration_fx_unavailable")
	ErrCreditValuationMigrationRepairInvalid    = errors.New("credit_valuation_migration_repair_invalid")
	ErrCreditValuationMigrationSuspendInvalid   = errors.New("credit_valuation_migration_suspend_invalid")
