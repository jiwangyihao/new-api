...
export const userSchema = z.object({
  ...
  invitation_commission_available_cents: z.number().optional(),
  invitation_commission_pending_cents: z.number().optional(),
  invitation_commission_withdrawn_cents: z.number().optional(),
  invitation_commission_transferred_cents: z.number().optional(),
  invitation_commission_earned_cents: z.number().optional(),
  invitation_commission_estimated_cents: z.number().optional(),
  invitation_commission_estimated_source_amount_cents: z.number().optional(),
  invitation_commission_estimated_event_count: z.number().optional(),
