...
type BillingSettler interface {
	...
	// CommitPreConsumedOnFailure marks the pre-consumed funding as non-refundable after
	// a response has already been delivered but final settlement failed.
	CommitPreConsumedOnFailure()
