...
func SubscriptionRequestEpay(c *gin.Context) {
	...
	uri, params, err := client.Purchase(&epay.PurchaseArgs{
		...
		Money:          formatCentsAsDecimalString(amountCents),
		Device:         epay.PC,
		NotifyUrl:      notifyUrl,
		ReturnUrl:      returnUrl,
	})
...
func SubscriptionEpayNotify(c *gin.Context) {
	...
	if err := completeSubscriptionOrderAndEvaluateInvitation(verifyInfo.ServiceTradeNo, common.GetJsonString(verifyInfo), model.PaymentProviderEpay, verifyInfo.Type); err != nil {
		_, _ = c.Writer.Write([]byte("fail"))
		return
	}
