...
func TestBuildCommandUsesCleanAllowlistEnvironment(t *testing.T) {
	...
	for _, required := range []string{"CHANNEL_UPSTREAM_MODEL_UPDATE_TASK_ENABLED=false", "CHANNEL_UPDATE_FREQUENCY=0", "UPDATE_TASK=false", "CHANNEL_TEST_FREQUENCY=0", "PYROSCOPE_URL=", "SYNC_UPSTREAM_BASE=", "RetryTimes=0", "AutomaticRetryStatusCodes=", "MEMORY_CACHE_ENABLED=true", "REDIS_POOL_SIZE=256", "REDIS_IDLE_TIMEOUT_SECONDS=1", "SQL_MAX_OPEN_CONNS=64", "SQL_MAX_IDLE_CONNS=64", "GOMEMLIMIT=384MiB", "NODE_TYPE=slave", "BATCH_UPDATE_ENABLED=false", "BATCH_UPDATE_INTERVAL=1", "RELAY_MAX_IDLE_CONNS=64", "RELAY_MAX_IDLE_CONNS_PER_HOST=16"} {
...
func safeEnv() map[string]string {
	return map[string]string{"HOST": "127.0.0.1", "PORT": "13080", "PPROF_ADDR": "127.0.0.1:8005", "SQL_DSN": "postgresql://new_api_loadtest:loadtest@127.0.0.1:15432/new_api_loadtest?sslmode=disable", "LOG_SQL_DSN": "", "REDIS_CONN_STRING": "redis://127.0.0.1:16379/0", "REDIS_POOL_SIZE": "256", "REDIS_IDLE_TIMEOUT_SECONDS": "1", "ENABLE_PPROF": "true", "LOADTEST_RUNTIME_STATS_ENABLED": "true", "LOADTEST_PROFILE_BLOCK_RATE": "1000", "LOADTEST_PROFILE_MUTEX_FRACTION": "5", "GOMAXPROCS": "2", "GOGC": "100", "GOMEMLIMIT": "384MiB", "NODE_TYPE": "slave", "BATCH_UPDATE_ENABLED": "false", "BATCH_UPDATE_INTERVAL": "1", "SQL_MAX_OPEN_CONNS": "64", "SQL_MAX_IDLE_CONNS": "64", "SQL_MAX_LIFETIME": "60", "CHANNEL_UPSTREAM_MODEL_UPDATE_TASK_ENABLED": "false", "CHANNEL_UPDATE_FREQUENCY": "0", "UPDATE_TASK": "false", "CHANNEL_TEST_FREQUENCY": "0", "PYROSCOPE_URL": "", "SYNC_UPSTREAM_BASE": "", "RetryTimes": "0", "AutomaticRetryStatusCodes": "", "MEMORY_CACHE_ENABLED": "true", "RELAY_MAX_IDLE_CONNS": "64", "RELAY_MAX_IDLE_CONNS_PER_HOST": "16"}
}
