...
type ConsoleSetting struct {
	...
	WelcomePopupContent   string `json:"welcome_popup_content"`   // 欢迎公告弹窗内容 (Markdown 文本)
	...
	WelcomePopupEnabled   bool   `json:"welcome_popup_enabled"`   // 是否启用欢迎公告弹窗
	WelcomePopupFrequency string `json:"welcome_popup_frequency"` // 欢迎公告展示频率
}

const DefaultWelcomePopupContent = "欢迎使用赔钱GPT！\n\n欢迎邀请好友使用赔钱GPT，邀请两位好友每月付费订阅，即可免费享受“一瓶盖可乐”付费订阅！\n\n填写邀请码或试用码可享用24小时GPT5.5畅用！\n\n官方QQ群：1106020227"
...
var defaultConsoleSetting = ConsoleSetting{
	...
	Announcements:         "",
	FAQ:                   "",
	WelcomePopupContent:   DefaultWelcomePopupContent,
	ApiInfoEnabled:        true,
	UptimeKumaEnabled:     true,
	AnnouncementsEnabled:  true,
	FAQEnabled:            true,
	WelcomePopupEnabled:   true,
	WelcomePopupFrequency: WelcomePopupFrequencyOncePerVersion,
}
