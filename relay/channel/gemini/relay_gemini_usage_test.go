...
func TestGeminiChatHandlerDoesNotEstimatePromptTokensWhenUsagePromptMissing(t *testing.T) {
	t.Parallel()
...
func TestGeminiStreamHandlerDoesNotEstimatePromptTokensWhenUsagePromptMissing(t *testing.T) {
	gin.SetMode(gin.TestMode)
	c, _ := gin.CreateTestContext(httptest.NewRecorder())
	c.Request = httptest.NewRequest(http.MethodPost, "/v1/chat/completions", nil)
...
func TestGeminiTextGenerationHandlerDoesNotEstimatePromptTokensWhenUsagePromptMissing(t *testing.T) {
	t.Parallel()
