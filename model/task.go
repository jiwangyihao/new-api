...
type Task struct {
	...
	Group      string                `json:"-" gorm:"type:varchar(50)"` // legacy business group column; ignored at runtime
...
type TaskBillingContext struct {
	...
	QuotaMultiplier float64            `json:"-"`                           // legacy business group ratio; ignored at runtime
